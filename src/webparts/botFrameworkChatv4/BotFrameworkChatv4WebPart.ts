...
export default class BotFrameworkChatv4WebPart extends BaseClientSideWebPart<
  IBotFrameworkChatv4WebPartProps
> {
  public render(): void {
      ...
      pages: [
        {
          header: {
            description:
              "Here you can set various properties and settings regarding how your bot chat web part will look visually and functionally work",
          },
          groups: [
            {
            ...
            },
            {
              ...
              groupFields: [
                ...
                PropertyPaneTextField("bubbleBackground", {
                  ...
                  onGetErrorMessage: this._validateColorPropertyAsync.bind(
                    this
                  ), // validation function
